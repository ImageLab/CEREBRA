...
class OBJParser
{
    public:
        ...
        static void parseLocationsInOBJFileFromFile(char *fileLocation, std::vector< std::pair<float, std::pair<float, float> > > &locations)
        {
            locations.clear();
        ...
        static void parseFacesInOBJFileFromFile(char *fileLocation, std::vector< std::pair<uint, std::pair<uint, uint> > > &faces)
        {
            faces.clear();
            std::ifstream shortFile(fileLocation);
            std::string currentLine;
